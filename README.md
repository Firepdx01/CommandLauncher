...
If you encounter issues downloading the [installer](https://github.com/Firepdx01/CommandLauncher/releases/latest/download/CommandLauncher.exe), consider using the [portable](https://github.com/Firepdx01/CommandLauncher/releases/latest/download/CommandLauncher-Portable-Windows.zip) version as an alternative.
